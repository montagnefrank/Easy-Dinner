...
$(document).on('click','.editarPedido', function() {
    ...
    var idsubmenu = $(this).parent().parent().find(".idsubmenu").html();
    var idmenu = $(this).parent().parent().find(".idmenu").html();
    nombreMenu = $(this).parent().parent().find(".menupedidoproducto").html();
    var nombreSubmenu = $(this).parent().parent().find(".submenupedidoproducto").html();
...
$(".btnEnviaProducto").click(function(){
    ...
    $.when(
        ...
        arrayProductos.push({"idProducto":idproducto,"nombreProducto":nombrepedidoproducto,"nombreMenu":nombreMenu,"ingredientesProducto":Ingredientes});
