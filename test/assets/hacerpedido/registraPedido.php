        ...
        foreach ($_POST["productos"] as $producto) {
            ...
            if (isset($producto["descripcionPedido"])) {
                ...
                if ($descripcionPedido == "entera") {
                    $q = "INSERT INTO pedidoproducto(idPedido,idProducto,descripcionPedidoproducto,estadoPedidoproducto) VALUES ('$idPedido', '$idproducto', '$descripcionPedido', 'SOLICITADO')";
                    $res = $conn->query($q);
                ...
                $q = "INSERT INTO pedidoproducto(idPedido,idProducto,descripcionPedidoproducto,estadoPedidoproducto) VALUES ('$idPedido', '$idproducto', 'Unitario', '$estado_pedido')";
                $res = $conn->query($q);
