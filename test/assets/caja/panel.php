    ...
    <div class="content-frame-left">                      
        ...
        <div class="widget widget-primary widget-item-icon">
            <div class="widget-item-right">
                <a href="index.php?panel=domicilio.php" style="color: white;" class="btnNuevoPedido">
...
<table class="table table-striped" id="facturaimpresa" style="display: none;" >
    <tbody>
        ...
        <tr>
            <td colspan="2"> Local: PIZZERIA DIRULO VILLAFLORA | Ruc: 1734230049001 | Factura: ######### | Tel&eacute;fono: ##########</td>
        </tr>
        <tr>
            <td>Fecha:</td>
            <td class="text-right ">2017-08-01</td>
        </tr>
        <tr>
            <td>Pago:</td>
        ...
        <tr>
            <td colspan="2"> Cliente: FRANK DE JESUS MONTAGNE VILLA | Ruc: 1734230049001</td>
        </tr>
        <tr>
            <td colspan="2">=======================================</td>
        </tr>
        <tr>
            <td colspan="2">CANT | PRODUCTO | PRECIO</td>
        </tr>
        <tr>
            <td colspan="2">=======================================</td>
        </tr>
        <tr>
            <td colspan="2"> 1 | Pizza Familia 4 estaciones | 24.43</td>
        </tr>
        <tr>
            <td colspan="2"> 1 | Pizza Familiar Casera Personalizada | 18.12</td>
        </tr>
        <tr>
            <td>Subtotal:</td>
        ...
        <tr>
            <td><strong>Total:</strong></td>
            <td class="text-right "><strong>$2,697.64</strong></td>
        </tr>
        <tr>
            <td colspan="2">=======================================</td>
        </tr>
