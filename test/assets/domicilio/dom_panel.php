                                                ...
                                                <tbody class="contentVisa">
                                                    <tr>
                                                        <td style="width:25%;padding:2px;">
                                                            <div class="form-group">
                                                                <label for="valor" class="control-label">$$</label>
                                                                <input type="text" onkeypress="return5 validateFloatKeyPress(this, event);" class="form-control monto_a_pagar" id="valorvisa" name="valorvisa" placeholder="$0.00" required>
                                                            </div>
                                                        </td>
