...
var idclientesel, nombre, precio, id, idSubmenu, nombreSubmenu, idmenu, nombreMenu, pizzaTemporal, arrayProductos = [],descripcionPedido = [];
...
function calcularVuelto() {
    ...
    console.log("VUELTO:" + vueltoaentregar);
}
...
$(document).on('click', '#payment_checkout', function () {
    ...
    if (renglones > 1) {
        ...
        $('#factura_checkout .modal-dialog .modal-content .modal-header .modal-title').html('<i class="fa fa-exclamation-circle"></i> Alerta</h4>');
        $('#factura_checkout .modal-dialog .modal-content .modal-body').html('<p></p>');
        $('#factura_checkout .modal-dialog .modal-content .modal-body p').html('No se ha seleccionado ning&uacute;n producto para facturar');
        $('#factura_checkout').modal('toggle');
    }
});
...
function enviaProducto(listaIngredientes, htmlIngredientes) {
    ...
    htmlPedido += "<br>" +
            ...
            "<button class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#modal_small\"><i class=\"fa fa-refresh\" aria-hidden=\"true\"></i> Cambiar</button>&nbsp;&nbsp;" +
            "<button class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#modal_small\"><i class=\"fa fa-plus-square\" aria-hidden=\"true\"></i> Adicionales</button>&nbsp;&nbsp;" +
            "<button class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#modal_small\"><i class=\"fa fa-plus-square-o\" aria-hidden=\"true\"></i> Comentarios</button>&nbsp;&nbsp;" +
...
$(".btnEnviaSeleccion").click(function () {
    console.log($(".radioPizzas input[type=radio]:checked").val());
