                    ...
                    success: function (ingredientes) {
                        ...
                        $.when(
                            ...
                            $(".contenidoSeleccionaIngredientes").append(
                                    ...
                                    '<div class="col-md-12">' +
                                    '<div class="form-group">' +
                                    '<h4 class="txt-primary">ObservaciÃ³n del producto :</h4>' +
                                    '<textarea class="form-control observacionProducto border-primary" rows="3" id="comment" style="resize: none;" placeholder="Ingrese aquÃ­ la observaciÃ³n del producto actual."></textarea>' +
                                    '</div>' +
                                    '</div>' +
                                    '</div>'
                                    );
